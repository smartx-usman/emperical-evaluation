...
# Create images
microstack.openstack image create --file Fedora-Cloud-Base-39-1.5.x86_64.raw --disk-format qcow2 --container-format bare --public Fedora-38

# Create Ubuntu VM instances from image
...
# Create Ubuntu VM instances from snapshots
...
# Create Fedora VM instances from snapshot
microstack.openstack server create --image 8db29dea-aa3f-4342-8913-d69ca2eb63cf --security-group de309f13-7c25-4b6b-86a1-95c5f9e3c02c --availability-zone nova:master --flavor m1.medium --network 1c18ccdb-e038-442c-bb77-68383fd3a359 master1
microstack.openstack server create --image 8db29dea-aa3f-4342-8913-d69ca2eb63cf --security-group de309f13-7c25-4b6b-86a1-95c5f9e3c02c --availability-zone nova:worker1 --flavor m1.small --network 1c18ccdb-e038-442c-bb77-68383fd3a359 worker1
microstack.openstack server create --image 8db29dea-aa3f-4342-8913-d69ca2eb63cf --security-group de309f13-7c25-4b6b-86a1-95c5f9e3c02c --availability-zone nova:worker2 --flavor m1.small --network 1c18ccdb-e038-442c-bb77-68383fd3a359 worker2
microstack.openstack server create --image 8db29dea-aa3f-4342-8913-d69ca2eb63cf --security-group de309f13-7c25-4b6b-86a1-95c5f9e3c02c --availability-zone nova:worker3 --flavor m1.small --network 1c18ccdb-e038-442c-bb77-68383fd3a359 worker3
